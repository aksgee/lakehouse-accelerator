# lakehouse_accelerator

The 'lakehouse_accelerator' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] lakehouse_accelerator_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/lakehouse_accelerator.job.yml). The schedule
